...
def compare_models(prompt: str) -> dict:
    ...
    gpt4o_response, gpt40_latency = call_openai(prompt)
...
if __name__ == "__main__":
    ...
    stats = run_assistant(
        persona="Bạn là chuyên gia hướng dẫn viên du lịch thân thiện, trả lời ngắn gọn bằng tiếng Việt. Hãy gợi ý lịch trình, địa điểm, món ăn và lưu ý thực tế theo nhu cầu của người dùng.",
    )
    print("\n--- Thống kê phiên chat ---")
